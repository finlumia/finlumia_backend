...
import br.com.finlumia.docs.support.config.ApiPaths;
import br.com.finlumia.docs.support.config.InternalSecurityProperties;
...
public class InternalServiceTokenFilter extends OncePerRequestFilter {
    ...
    static boolean requiresInternalServiceToken(String requestUri) {
        ...
        if (requestUri.startsWith(ApiPaths.INTERNAL_DOCS_INTERNAL)) return true;
        if (!requestUri.startsWith(ApiPaths.INTERNAL_API_PREFIX + "/")) return false;
