...
import br.com.finlumia.identify.config.ApiPaths;
import br.com.finlumia.identify.config.PublicApiProperties;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter implements ExternalApiAuthenticationFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            tokenService.ensureAccessTokenIsActive(accessToken);
